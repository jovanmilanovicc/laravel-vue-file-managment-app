<template>
  ...
  <ConfirmationDialog :show="showDeleteDialog" message="Are you sure u want to delete selected files"
    @cancel="onDeleteCandel" @confirm="onDeleteConfirm">
  </ConfirmationDialog>
</template>
...
function onDeleteConfirm() {
  ...
  console.log("Deleting", props.deleteAll, props.deleteIds)
}
</script>
